CREATE TABLE vacancies (
    ...
    source_url TEXT NOT NULL, description TEXT NOT NULL, notes TEXT NOT NULL,
...
CREATE TABLE documents (id TEXT PRIMARY KEY, title TEXT NOT NULL, kind TEXT NOT NULL CHECK(kind IN ('resume','cover-letter','note')));
CREATE TABLE document_versions (
    id TEXT PRIMARY KEY, document_id TEXT NOT NULL REFERENCES documents(id),
    number INTEGER NOT NULL, file_name TEXT NOT NULL UNIQUE, created_at TEXT NOT NULL,
    UNIQUE(document_id, number)
);
CREATE TABLE applications (
    id TEXT PRIMARY KEY, vacancy_id TEXT NOT NULL UNIQUE REFERENCES vacancies(id),
    stage TEXT NOT NULL CHECK(stage IN ('preparing','applied','interview','offer','rejected','withdrawn')),
    next_action TEXT NOT NULL, due_date TEXT NOT NULL, notes TEXT NOT NULL,
    submitted_at TEXT, created_at TEXT NOT NULL, updated_at TEXT NOT NULL
);
